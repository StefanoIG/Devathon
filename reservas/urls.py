...
from .views import create_reserva, cancel_reserva, confirmar_reserva, UserReservationsView
...
urlpatterns = [
    ...
    path('api/v1/listar-reservas/', UserReservationsView.as_view(), name='listar_reservas'),  # Ruta para listar reservas
]
